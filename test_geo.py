...
def test_rivers_with_station():
    rivers_with_station_set = rivers_with_station(create_test_station_list())
    assert rivers_with_station_set == {"River Cam", "River Thames"}

def test_stations_by_river():
    stations = create_test_station_list()
    stations_by_river_dict = stations_by_river(stations)
    assert stations_by_river_dict == {"River Cam": stations[0:2], "River Thames": stations[2:]}
